...
export default function ProductsItem(props) {
    ...
    const handleR = () => {
        // Use stock from data or default to 100
        const stock = props.fulldata?.stock || 100;
        if (val < stock) {
            setVal(val + 1)
        }
    }
    ...
    return (
        <div className="ProductsItemBox">
            <div className='ProductsItem'>
                <div className="ProductImgSec">
                    {/* UPDATED: Checking props.data.imgUrl instead of image */}
                    {props.data.imgUrl ? (
                        <img 
                        ...
                        // Gray Tube Placeholder if imgUrl is missing/null
                        <div 
                            style={{
                                width: '100%',
                                height: '200px',
                ...
                <div className="ProductBody">
                    ...
                    <div className="ProductPrice">
                        <div className="ProductAdd">
                            <button className='Productl' onClick={handleL} >-</button>
                            <button className='Productm'>{val}</button>
                            <button className='Productr' onClick={handleR}>+</button>
                        </div>
                    </div>
                </div>
            </div>
