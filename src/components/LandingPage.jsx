      ...
      <div className='LandingPage'>
        <div className="LandingCon">
          <h1 className='Lheading'>
            West End Market <br/> 
            <span style={{fontSize: '0.6em', fontWeight: '400'}}>Your Local Stop on Staniford St.</span>
          </h1>
          <div className="LQ">
            <div className='LQ1'>
              ...
              <p>
              From fresh coffee and deli sandwiches to smoke shop essentials and frozen favorites. We have everything you need, right here in the West End.
              </p>
